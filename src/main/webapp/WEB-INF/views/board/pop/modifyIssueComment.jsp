    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 blog-main">
			...
			<form action="${pageContext.request.contextPath}/board/modifyIssueCommentSubmit" id="modify-comment" class="comment-container" autocomplete="off" name="post/comment_modify" method="post"  enctype='multipart/form-data'><fieldset> 
...
<script>
	...
	function loadData(seq)
	{
		...
		$.ajax({
			...
			data:data,
			dataType:"json",
			url:"${pageContext.request.contextPath}/board/getModifyIssueComment",
